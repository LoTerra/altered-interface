...
export default function Equilibrium(props) {
   ...
   return (
    ...
    <path d="M-2.96495e-06 70.1697L51.2718 0.000287914L100.572 70.1697L51.2718 138L-2.96495e-06 70.1697Z" fill="url(#paint0_linear)" fill-opacity="0.81"/>
    <path d="M198 70.3022L50.2854 138L98.5581 70.3022L198 70.3022Z" fill="url(#paint1_linear)" fill-opacity="0.9"/>
    <path d="M198 70.3018L98.5581 70.3018L50.2854 3.05176e-05L198 70.3018Z" fill="url(#paint2_linear)" fill-opacity="0.89"/>
    <path d="M396 70.1697L344.728 0.000287914L295.428 70.1697L344.728 138L396 70.1697Z" fill="url(#paint3_linear)" fill-opacity="0.81"/>
    <path d="M198 70.3022L345.715 138L297.442 70.3022L198 70.3022Z" fill="url(#paint4_linear)" fill-opacity="0.9"/>
    <path d="M198 70.3018L297.442 70.3018L345.715 3.05176e-05L198 70.3018Z" fill="url(#paint5_linear)" fill-opacity="0.89"/>
    <defs>
    <linearGradient id="paint0_linear" x1="40.5484" y1="138.204" x2="68.9873" y2="38.9465" gradientUnits="userSpaceOnUse">
    <stop stop-color={colorGood_0.start}/>
    <stop offset="1" stop-color={colorGood_0.stop}/>
    </linearGradient>
    <linearGradient id="paint1_linear" x1="50.2854" y1="104.151" x2="198" y2="104.151" gradientUnits="userSpaceOnUse">
    <stop stop-color={colorGood_1.start}/>
    <stop offset="1" stop-color={colorGood_1.stop}/>
    </linearGradient>
    <linearGradient id="paint2_linear" x1="50.2854" y1="35.1509" x2="198" y2="35.1509" gradientUnits="userSpaceOnUse">
    <stop stop-color={colorGood_2.start}/>
    <stop offset="1" stop-color={colorGood_2.stop}/>
    </linearGradient>
